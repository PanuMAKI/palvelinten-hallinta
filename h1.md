...
## b)
Ensin tarkistin päivitykset komennolla $ sudo apt-get update ja latasin Wgatin komennolla $ sudo apt-get install wget. jonka jälkeen loin uuden hakemiston "saltrepo" komennolla $ mkdir saltrepo. 
